...
from PyQt5.QtWidgets import QWidget,QMainWindow, QApplication, QLabel, QSizePolicy, QVBoxLayout, QAction, QPushButton, QDesktopWidget, QApplication,QGridLayout,QHBoxLayout
    ...
    def conn(self,form):
        ...
        try:
           #QTimer.singleShot(5000, lambda:self.on_connect())
            ...
            QTimer.singleShot(3300, lambda:self.CallNewForm())
...
class CvTag(QtWidgets.QDialog):
    ...
    def __init__(self):
        ...
        #self.label4.setGeometry(QtCore.QRect(430, 330, 200, 140))
        self.setStyleSheet("background-color: rgb(30, 30, 30);")
        self.label.setText("")
    ...
    def setWindow1(self):
        ...
        self.b3.clicked.connect(self.CloseDialog1)
        ...
        self.b10.setGeometry(QtCore.QRect(0, 0, 1, 1))
        self.b11.setGeometry(QtCore.QRect(0, 0, 1, 1))
        self.b12.setGeometry(QtCore.QRect(0, 0, 1, 1))
    ...
    def train(self):
        ...
        #self.b3.clicked.connect(lambda:self.CloseDialog2())
        self.b10.setGeometry(QtCore.QRect(10, 400, 113, 50))
        self.b10.setObjectName("pushButton")
        self.b10.setText("Back")
        self.b10.clicked.connect(self.CloseDialog2)
        self.endT()
    ...
    def startT(self):
        ...
        self.b8.clicked.connect(lambda: self.saveD())
        self.b10.clicked.connect(self.CloseDialog2)
    ...
    def endT(self):
        ...
        self.b9.clicked.connect(lambda: self.startT())
    ...
    def auto(self):
        ...
        self.b11.clicked.connect(lambda:self.sendToServer(str(3).encode()))
        ...
        self.b12.clicked.connect(self.CloseDialog3)
